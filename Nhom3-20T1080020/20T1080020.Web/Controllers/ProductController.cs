...
namespace _20T1080020.Web.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            Models.ProductSearchInput condition
                = Session[SESSION_CONDITION] as Models.ProductSearchInput;
        ...
        public ActionResult Save(Product data, HttpPostedFileBase uploadPhoto)
        {
            ...
            if (string.IsNullOrWhiteSpace(data.Unit))
                ModelState.AddModelError(nameof(data.Unit), "đơn vị tính không được trống");
        ...
        {
            ViewBag.Title = "Xóa nhà mặt hàng";
            if (id <= 0)
                return RedirectToAction("Index");
        ...
        public ActionResult SavePhoto(ProductPhoto data, HttpPostedFileBase uploadPhoto)
        {
            ...
            if (uploadPhoto != null)
            {
                string storage = Server.MapPath("~/Images/Products");
